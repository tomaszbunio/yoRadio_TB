...
********************************************************/
    ...
    #include "../../mywifi.h" /* <- dev only, gitignored */
#endif
    ...
    #endif
#else
    #if __has_include("../displays/conf/customs_themes/mytheme_gray.h")
        #include "../displays/conf/customs_themes/mytheme_gray.h"
    #endif
#endif
...
#endif
#ifndef SD_PLAYER_ANALYZER_BANDS
  #define SD_PLAYER_ANALYZER_BANDS 16 // bars for SD_PLAYER analyzer (no-touch layout)
#endif
#ifndef SD_PLAYER_ANALYZER_GAP
  #define SD_PLAYER_ANALYZER_GAP 2     // horizontal gap between analyzer bars (px)
#endif
/*
