...
#if IR_PIN!=255
enum : uint8_t {
  IR_UP=0, IR_PREV=1, IR_PLAY=2, IR_NEXT=3, IR_DOWN=4,
  IR_1=5, IR_2=6, IR_3=7, IR_4=8, IR_5=9, IR_6=10, IR_7=11,
  IR_8=12, IR_9=13, IR_AST=14, IR_0=15, IR_HASH=16,
  IR_POWER=17, IR_MENU=18, IR_MUTE=19, IR_VOL_UP=20,
  IR_VOL_DOWN=21, IR_HOME=22, IR_BACK=23, IR_ACTION_COUNT=24
};
#endif
