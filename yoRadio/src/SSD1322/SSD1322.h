...
class Jamis_SSD1322 : public Adafruit_GFX {
  public:
    Jamis_SSD1322(int16_t w, int16_t h, SPIClass* spi, int8_t dc_pin, int8_t rst_pin, int8_t cs_pin, uint32_t bitrate = 8000000UL);
    ...
    void         ssd1322_setMasterContrast(uint8_t v);
    void         ssd1322_setContrast(uint8_t value);
