const uint8_t VT_DIGI_OLD_35x21Bitmaps[] PROGMEM = {
...
const GFXglyph VT_DIGI_OLD_35x21Glyphs[] PROGMEM = {
  {     0,   0,   0,  11,    0,    1 },   // 0x20 ' '
  {     0,   0,   0,   0,    0,    0 },   // 0x21 '!'
  {     0,   0,   0,   0,    0,    0 },   // 0x22 '"'
  {     0,   0,   0,   0,    0,    0 },   // 0x23 '#'
...
const GFXfont Clock_GFXfont_sec PROGMEM = {
  (uint8_t  *)VT_DIGI_OLD_35x21Bitmaps,  
  (GFXglyph *)VT_DIGI_OLD_35x21Glyphs, 0x20, 0x3A,    55 };
