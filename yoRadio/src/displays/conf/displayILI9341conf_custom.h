...
const WidgetConfig namedayConf    = { TFT_FRAMEWDT, 139, 1, WA_LEFT }; // Módosítás új sor "nameday"
const WidgetConfig dateConf    = { TFT_FRAMEWDT *2, 169, 1, WA_LEFT }; // Módosítás új sor "date"
