...
const WidgetConfig namedayConf    = { TFT_FRAMEWDT, 175, 2, WA_LEFT };  // Módosítás új sor "nameday"
const WidgetConfig dateConf    = { TFT_FRAMEWDT *2, 226, 1, WA_LEFT }; // Módosítás új sor "date"
